...
import { Box, Button, Label, Select, Icon, Input } from "@adminjs/design-system";
  ...
  return (
    <Box variant="grey">
      <Box>
        ...
        <Input type="number" value={slots.length} onChange={handleTeamSizeChange} />
      </Box>
      ...
      <Button type="button" mt="lg" onClick={handleAddSlot}>
        + Add Slots
      </Button>
    </Box>
  );
